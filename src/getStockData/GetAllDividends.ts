...
async function fetchDividendHistory(ticker: any) {
...
function formatDividendHistory(dividendHistory: any) {
...
export default async function getAllDividends(ticker: any) {
